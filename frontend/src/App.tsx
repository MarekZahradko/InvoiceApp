...
// inner layout — has access to useLocation inside <Router>
function AppLayout() {
  ...
  return (
    <div className="min-vh-100 d-flex flex-column">
      ...
      {/* navigation bar — hidden on login and register pages */}
      {!isAuthPage && (
      ...
      <footer className="text-center text-muted small border-top py-3 mt-4">
        © 2026 Marek Zahradko &nbsp;·&nbsp; Výukový projekt vytvořen s pomocí materiálů{" "}
        <a href="https://www.itnetwork.cz" target="_blank" rel="noreferrer" className="text-muted">
          ITnetwork.cz
        </a>
        &nbsp;·&nbsp; Kód spadá pod licenci prémiového obsahu
      </footer>
    </div>
  );
}
